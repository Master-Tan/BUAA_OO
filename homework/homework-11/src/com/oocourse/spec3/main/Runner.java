...
public class Runner {
    ...
    private final Class<? extends Group> groupClass;
    private final Class<? extends Message> messageClass;
    private final Class<? extends EmojiMessage> emojiClass;
    private final Class<? extends NoticeMessage> noticeClass;
    private final Class<? extends RedEnvelopeMessage> redEnvelopeClass;
    private final Constructor<? extends Person> personConstructor;
    private final Constructor<? extends Network> networkConstructor;
    private final Constructor<? extends Group> groupConstructor;
    ...
    private void addGroup()
        ...
        int id = Integer.parseInt(cmds[1]);
        try {
            network.addGroup(this.groupConstructor.newInstance(id));

...
public interface Network {
    ...
    /*@ public normal_behavior
      ...
      @*/
    void addPerson(/*@ non_null @*/Person person) throws EqualPersonIdException;
    ...
    /*@ public normal_behavior
      ...
      @         !getPerson(id1).isLinked(getPerson(id2));
      @*/
    /*@ pure @*/ int queryValue(int id1, int id2) throws
            PersonIdNotFoundException, RelationNotFoundException;

    //@ ensures \result == people.length;
    /*@ pure @*/ int queryPeopleSum();
    ...
    /*@ public normal_behavior
      ...
      @ signals (PersonIdNotFoundException e) contains(id1) && !contains(id2);
      @*/
    /*@ pure @*/ boolean isCircle(int id1, int id2) throws PersonIdNotFoundException;
    ...
    /*@ public normal_behavior
      ...
      @*/
    /*@ pure @*/ int queryLeastConnection(int id) throws PersonIdNotFoundException;
    ...
    /*@ public normal_behavior
      ...
      @*/
    void addGroup(/*@ non_null @*/Group group) throws EqualGroupIdException;
    ...
    /*@ public normal_behavior
      ...
      @*/
    void addToGroup(int id1, int id2) throws GroupIdNotFoundException,
    ...
    /*@ public normal_behavior
      ...
      @          groups[i].getId() == id);
      @*/
    /*@ pure @*/ int queryGroupPeopleSum(int id) throws GroupIdNotFoundException;
    ...
    /*@ public normal_behavior
      ...
      @          groups[i].getId() == id);
      @*/
    /*@ pure @*/ int queryGroupValueSum(int id) throws GroupIdNotFoundException;
    ...
    /*@ public normal_behavior
      ...
      @          groups[i].getId() == id);
      @*/
    /*@ pure @*/ int queryGroupAgeVar(int id) throws GroupIdNotFoundException;
    ...
    /*@ pure @*/ boolean containsMessage(int id);
    ...
    /*@ public normal_behavior
      ...
      @ ensures \result == null;
      @*/
    /*@ pure @*/ Message getMessage(int id);
    ...
    /*@ public normal_behavior
      ...
      @ signals (PersonIdNotFoundException e) !contains(id);
      @*/
    /*@ pure @*/ int querySocialValue(int id) throws PersonIdNotFoundException;
    ...
    /*@ public normal_behavior
      ...
      @ signals (PersonIdNotFoundException e) !contains(id);
      @*/
    /*@ pure @*/ List<Message> queryReceivedMessages(int id) throws PersonIdNotFoundException;

    //@ ensures \result == (\exists int i; 0 <= i && i < emojiIdList.length; emojiIdList[i] == id);
    /*@ pure @*/ boolean containsEmojiId(int id);
    ...
    /*@ public normal_behavior
      ...
      @ signals (PersonIdNotFoundException e) !contains(id);
      @*/
    /*@ pure @*/ int queryMoney(int id) throws PersonIdNotFoundException;
    ...
    /*@ public normal_behavior
      ...
      @*/
    /*@ pure @*/ int queryPopularity(int id) throws EmojiIdNotFoundException;
    ...
    /*@ public normal_behavior
      ...
      @*/
    int sendIndirectMessage(int id) throws

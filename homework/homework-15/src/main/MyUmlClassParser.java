...
public class MyUmlClassParser {
    ...
    private HashMap<String, UmlClassOrInterface> umlClassOrInterface;
    ...
    public MyUmlClassParser(HashMap<String, MyClassOrInterface> myClassOrInterfaces,
                            HashMap<String, UmlClassOrInterface> umlClassOrInterfaces,
                            HashMap<String, MyOperation> myOperations,
                            HashMap<String, Integer> classNames,
                            HashMap<String, String> classNameToId,
                            HashMap<String, MyAssociation> myAssociations,
                            HashMap<String, MyAssociationEnd> myAssociationEnds) {

        this.myClassOrInterfaces = myClassOrInterfaces;
        this.umlClassOrInterface = umlClassOrInterfaces;
        this.myOperations = myOperations;
        this.classNames = classNames;
        this.classNameToId = classNameToId;
        this.myAssociations = myAssociations;
        this.myAssociationEnds = myAssociationEnds;
